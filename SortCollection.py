...
class Sort:
	def collection()->Dict[str,Callable[[List[int]],List[int]]]:
		sorts=[
			Sort.native,
			Sort.bubble,
			Sort.select,
	...
	@staticmethod
	def collectionAsync()->Dict[str,Callable[[List[int]],Awaitable[List[int]]]]:
		sorts={}
		def toAsync(fn):
			async def toAsync(l:List[int])->Awaitable[List[int]]:
				return fn(l)
			return toAsync
	...
	@staticmethod
	def native(lst0:List[int])->List[int]:
		return sorted(lst0)

	@staticmethod
	def bubble(lst0:List[int])->List[int]:
		lst=lst0.copy()
	...
	@staticmethod
	def select(lst0:List[int])->List[int]:
		lst=lst0.copy()
		for i in range(len(lst)-1):
	...
	@staticmethod
	def insert(lst0:List[int])->List[int]:
		lst=lst0.copy()
	...
	@staticmethod
	def gnome(lst0:List[int])->List[int]:
		lst=lst0.copy()
		for i in range(1,len(lst)):
			for n in range(i):
				if lst[i]<lst[n]:
	...
	@staticmethod
	def comb(lst0:List[int])->List[int]:
		lst=lst0.copy()
		h=len(lst)
		isSwap:bool
		while True:
	...
	@staticmethod
	def fshell(lst0:List[int])->List[int]:
		lst=lst0.copy()
		h=0
	...
	@staticmethod
	def heap(lst0:List[int])->List[int]:
		heap=lst0.copy()
		last=len(heap)-1
	...
	@staticmethod
	def merge(lst0:List[int])->List[int]:
	...
	@staticmethod
	def quick(lst0:List[int])->List[int]:
		lst=lst0.copy()
	...
	@staticmethod
	def bucket(lst0:List[int])->List[int]:
		offset=min(lst0)
	...
	@staticmethod
	def radix(lst0:List[int])->List[int]:
	...
	@staticmethod
	def pigeon(lst0:List[int])->List[int]:
		offset=min(lst0)
		if 0<=offset: offset=0
	...
	@staticmethod
	def bogo(lst0:List[int])->List[int]:
		while True:
			lst=xs.shuffle(lst0)
	...
	@staticmethod
	async def sleep(lst0:List[int])->Awaitable[List[int]]:
		offset=min(lst0)
		if 0<=offset: offset=0
		lst=[]
		async def fn(i):
