...
recorder:str="./record.csv"
titles:str="RUNTIMES, TIMES, MS, TIMES/S, N, COMPLITE,\n"

class SortRecorder:
	def __init__(self,runtimes:str,platform:str,sortName:str,times:int,ms:int,n:int,complited:bool):
